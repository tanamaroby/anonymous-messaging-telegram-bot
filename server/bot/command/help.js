...
+ "Before listing the features, if you are using this bot for the first time in a Telegram group, each user will have to type /hellobot for the bot to function properly in the group 🙏.";

const feature1 = "1. Wakabubot will perform check-in on groups twice a week on Wednesday and Sunday. It will ask the group members to rate how they feel for that week and send an anonymized result in the group once "
